	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'floating-gradient': 'var(--floating-gradient)',
			},
			boxShadow: {
				'google': 'var(--shadow-md)',
			...
			spacing: {
				'google-xs': 'var(--space-xs)',
				'google-sm': 'var(--space-sm)',
				'google-md': 'var(--space-md)',
				'google-lg': 'var(--space-lg)',
				'google-xl': 'var(--space-xl)',
				'google-2xl': 'var(--space-2xl)',
				'google-3xl': 'var(--space-3xl)',
			},
			borderRadius: {
				lg: 'var(--radius)',
